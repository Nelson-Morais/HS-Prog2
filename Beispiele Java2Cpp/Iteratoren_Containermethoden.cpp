...
int main() {
  ...
  it=l.insert(pos,6); l.insert(it,5);  // Einfuegen von rechts nach links
  info(l);
  l.insert(pos,7); l.insert(pos,8);    // Einfuegen von links nach rechts
  info(l);
  ...
  it=l.erase(pos); info(l);       // pos jetzt ungueltig
  it=l.erase(it,l.end()); info(l);// Loeschen bis zum Listenende
