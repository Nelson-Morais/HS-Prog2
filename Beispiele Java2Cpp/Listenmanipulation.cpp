 ...
 * -----------------------------------------------------------------------------
 *
 * Beispielprogramm: Listenzugriff.cpp
 *
...
int main() {
  ...
  cout << "unique(IstBetragsGleich()): ";info(ll);
  cin.get();
  ...
  cout << "sort(BetragKleiner()): ";info(ll);
  cin.get();
  ...
  // Vorher:
  cout << "alteListe:               "; info(ll);
  cout << "zweiteListe:             "; info(zweiteListe);
  ...
  cout << "merge(BetragKleiner()): "; info(ll);
  cout << "zweiteListe              "; info(zweiteListe);
